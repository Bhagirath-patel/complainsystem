...
$("#updateh").click(function(){
  ...
  <div class="container-fluid"  style="background-color:#778899;">
   ...
   <li class="xyz" id="department"><a href="complaint.php"><h3>Home</h3></a>
	...
	<li class="xyz" id="logout"><a href="adddepart.php?reff=1" id="deleteh" ><h3>Logout</h3></a></li>
	</ul>
     </div>
<div class="container-fluid" style="background-color:#a9a9a9">
<table class="table table-hover">
<form  method="post" action="regDepart.php">
...
<option value="Computer Science and Engineering">Computer Science and Engineering</option>
        ...
        <tr><td>Department ID:</td><td><input type="text" name="did" required="required"></td></tr>
      <tr><td> HOD name:</td><td><input type="text" name="hodname" required="required"></td></tr>
        <tr><td>Official Email:</td><td><input type="email" name="email" required="required" ></td></tr>
      <tr><td>Phone No:</td><td><input type="text" name="phno" required="required"></td><tr>
   
  <tr><td>Working Time:</td><td> <input type="time" name="time1">To&nbsp;&nbsp; <input type="time" name="time2"></td><td>   </td><tr>
     <tr><td>No. of Faculties in Department:</td><td><input type="text" name="nf" required="required"></td><tr>
        <tr><td>Name Of faculties:<br>(Seperated By Comma)</td><td><textarea name="fn" rows="5" cols="100" required="required"></textarea></td></tr>
      </table>      
